...
public class Transformation {
 ...
 public Transformation(String TitreImage, String DescreptionImage, String ImageAvant, String ImageApres, float PoidAvant, float PoidApres, float TailleAvant, float TailleApres) {
        this.TitreImage = TitreImage;
        this.DescreptionImage = DescreptionImage;
        this.ImageAvant = ImageAvant;
        this.ImageApres = ImageApres;
